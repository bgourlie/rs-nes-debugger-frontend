module Icons exposing (breakpoint, continue, magnifyingGlass, step, styles)
...
breakpoint =
    svg
        [ Svg.Attributes.class <| toString BreakpointIcon, viewBox "0 0 20 20" ]
        [ circle
...
continue : Html msg
continue =
    svg [ Svg.Attributes.class <| toString ButtonIcon, viewBox buttonViewBox ]
        [ path
